...
_INVITATIONINFO = DESCRIPTOR.message_types_by_name['InvitationInfo']
_CREATEINVITATIONSREQUEST = DESCRIPTOR.message_types_by_name['CreateInvitationsRequest']
_CREATEINVITATIONSRESPONSE = DESCRIPTOR.message_types_by_name['CreateInvitationsResponse']
_DELETEINVITATIONSREQUEST = DESCRIPTOR.message_types_by_name['DeleteInvitationsRequest']
_DELETEINVITATIONSRESPONSE = DESCRIPTOR.message_types_by_name['DeleteInvitationsResponse']
_INVITATION = DESCRIPTOR.message_types_by_name['Invitation']
_LISTINVITATIONSREQUEST = DESCRIPTOR.message_types_by_name['ListInvitationsRequest']
_LISTINVITATIONSRESPONSE = DESCRIPTOR.message_types_by_name['ListInvitationsResponse']
_VERIFYINVITATIONREQUEST = DESCRIPTOR.message_types_by_name['VerifyInvitationRequest']
_VERIFYINVITATIONRESPONSE = DESCRIPTOR.message_types_by_name['VerifyInvitationResponse']
...
GetAccessTokenRequest = _reflection.GeneratedProtocolMessageType('GetAccessTokenRequest', (_message.Message,), {
  ...
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.GetAccessTokenRequest)
  })
...
GetAccessTokenResponse = _reflection.GeneratedProtocolMessageType('GetAccessTokenResponse', (_message.Message,), {
  ...
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.GetAccessTokenResponse)
  })
_sym_db.RegisterMessage(GetAccessTokenResponse)

InvitationInfo = _reflection.GeneratedProtocolMessageType('InvitationInfo', (_message.Message,), {
  'DESCRIPTOR' : _INVITATIONINFO,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.InvitationInfo)
  })
_sym_db.RegisterMessage(InvitationInfo)

CreateInvitationsRequest = _reflection.GeneratedProtocolMessageType('CreateInvitationsRequest', (_message.Message,), {
  'DESCRIPTOR' : _CREATEINVITATIONSREQUEST,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.CreateInvitationsRequest)
  })
_sym_db.RegisterMessage(CreateInvitationsRequest)

CreateInvitationsResponse = _reflection.GeneratedProtocolMessageType('CreateInvitationsResponse', (_message.Message,), {
  'DESCRIPTOR' : _CREATEINVITATIONSRESPONSE,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.CreateInvitationsResponse)
  })
_sym_db.RegisterMessage(CreateInvitationsResponse)

DeleteInvitationsRequest = _reflection.GeneratedProtocolMessageType('DeleteInvitationsRequest', (_message.Message,), {
  'DESCRIPTOR' : _DELETEINVITATIONSREQUEST,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.DeleteInvitationsRequest)
  })
_sym_db.RegisterMessage(DeleteInvitationsRequest)

DeleteInvitationsResponse = _reflection.GeneratedProtocolMessageType('DeleteInvitationsResponse', (_message.Message,), {
  'DESCRIPTOR' : _DELETEINVITATIONSRESPONSE,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.DeleteInvitationsResponse)
  })
_sym_db.RegisterMessage(DeleteInvitationsResponse)

Invitation = _reflection.GeneratedProtocolMessageType('Invitation', (_message.Message,), {
  'DESCRIPTOR' : _INVITATION,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.Invitation)
  })
_sym_db.RegisterMessage(Invitation)

ListInvitationsRequest = _reflection.GeneratedProtocolMessageType('ListInvitationsRequest', (_message.Message,), {
  'DESCRIPTOR' : _LISTINVITATIONSREQUEST,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.ListInvitationsRequest)
  })
_sym_db.RegisterMessage(ListInvitationsRequest)

ListInvitationsResponse = _reflection.GeneratedProtocolMessageType('ListInvitationsResponse', (_message.Message,), {
  'DESCRIPTOR' : _LISTINVITATIONSRESPONSE,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.ListInvitationsResponse)
  })
_sym_db.RegisterMessage(ListInvitationsResponse)

VerifyInvitationRequest = _reflection.GeneratedProtocolMessageType('VerifyInvitationRequest', (_message.Message,), {
  'DESCRIPTOR' : _VERIFYINVITATIONREQUEST,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.VerifyInvitationRequest)
  })
_sym_db.RegisterMessage(VerifyInvitationRequest)

VerifyInvitationResponse = _reflection.GeneratedProtocolMessageType('VerifyInvitationResponse', (_message.Message,), {
  'DESCRIPTOR' : _VERIFYINVITATIONRESPONSE,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.VerifyInvitationResponse)
  })
_sym_db.RegisterMessage(VerifyInvitationResponse)

ListUsersRequest = _reflection.GeneratedProtocolMessageType('ListUsersRequest', (_message.Message,), {
  'DESCRIPTOR' : _LISTUSERSREQUEST,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.ListUsersRequest)
  })
...
ListUsersResponse = _reflection.GeneratedProtocolMessageType('ListUsersResponse', (_message.Message,), {
  ...
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.ListUsersResponse)
  })
...
User = _reflection.GeneratedProtocolMessageType('User', (_message.Message,), {
  'DESCRIPTOR' : _USER,
  '__module__' : 'server.v1.auth_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.auth.v1.User)
  })
