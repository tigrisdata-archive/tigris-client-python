...
_CREATEORUPDATEINDEXREQUEST = DESCRIPTOR.message_types_by_name['CreateOrUpdateIndexRequest']
_INDEXSOURCE = DESCRIPTOR.message_types_by_name['IndexSource']
_CREATEORUPDATEINDEXRESPONSE = DESCRIPTOR.message_types_by_name['CreateOrUpdateIndexResponse']
...
_INDEXINFO = DESCRIPTOR.message_types_by_name['IndexInfo']
_LISTINDEXESRESPONSE = DESCRIPTOR.message_types_by_name['ListIndexesResponse']
_DOCSTATUS = DESCRIPTOR.message_types_by_name['DocStatus']
...
_CREATEBYIDREQUEST = DESCRIPTOR.message_types_by_name['CreateByIdRequest']
_CREATEBYIDRESPONSE = DESCRIPTOR.message_types_by_name['CreateByIdResponse']
...
_CREATEORREPLACEDOCUMENTREQUEST = DESCRIPTOR.message_types_by_name['CreateOrReplaceDocumentRequest']
_CREATEORREPLACEDOCUMENTRESPONSE = DESCRIPTOR.message_types_by_name['CreateOrReplaceDocumentResponse']
...
_DELETEBYQUERYREQUEST = DESCRIPTOR.message_types_by_name['DeleteByQueryRequest']
_DELETEBYQUERYRESPONSE = DESCRIPTOR.message_types_by_name['DeleteByQueryResponse']
_SEARCHINDEXREQUEST = DESCRIPTOR.message_types_by_name['SearchIndexRequest']
_SEARCHINDEXRESPONSE = DESCRIPTOR.message_types_by_name['SearchIndexResponse']
_SEARCHINDEXRESPONSE_FACETSENTRY = _SEARCHINDEXRESPONSE.nested_types_by_name['FacetsEntry']
CreateOrUpdateIndexRequest = _reflection.GeneratedProtocolMessageType('CreateOrUpdateIndexRequest', (_message.Message,), {
  'DESCRIPTOR' : _CREATEORUPDATEINDEXREQUEST,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.CreateOrUpdateIndexRequest)
  })
_sym_db.RegisterMessage(CreateOrUpdateIndexRequest)

IndexSource = _reflection.GeneratedProtocolMessageType('IndexSource', (_message.Message,), {
  'DESCRIPTOR' : _INDEXSOURCE,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.IndexSource)
  })
_sym_db.RegisterMessage(IndexSource)

CreateOrUpdateIndexResponse = _reflection.GeneratedProtocolMessageType('CreateOrUpdateIndexResponse', (_message.Message,), {
  'DESCRIPTOR' : _CREATEORUPDATEINDEXRESPONSE,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.CreateOrUpdateIndexResponse)
  })
_sym_db.RegisterMessage(CreateOrUpdateIndexResponse)

GetIndexRequest = _reflection.GeneratedProtocolMessageType('GetIndexRequest', (_message.Message,), {
  'DESCRIPTOR' : _GETINDEXREQUEST,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.GetIndexRequest)
  })
...
GetIndexResponse = _reflection.GeneratedProtocolMessageType('GetIndexResponse', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.GetIndexResponse)
  })
...
DeleteIndexRequest = _reflection.GeneratedProtocolMessageType('DeleteIndexRequest', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.DeleteIndexRequest)
  })
...
DeleteIndexResponse = _reflection.GeneratedProtocolMessageType('DeleteIndexResponse', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.DeleteIndexResponse)
  })
...
ListIndexesRequest = _reflection.GeneratedProtocolMessageType('ListIndexesRequest', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.ListIndexesRequest)
  })
...
IndexInfo = _reflection.GeneratedProtocolMessageType('IndexInfo', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.IndexInfo)
  })
...
ListIndexesResponse = _reflection.GeneratedProtocolMessageType('ListIndexesResponse', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.ListIndexesResponse)
  })
_sym_db.RegisterMessage(ListIndexesResponse)

DocStatus = _reflection.GeneratedProtocolMessageType('DocStatus', (_message.Message,), {
  'DESCRIPTOR' : _DOCSTATUS,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.DocStatus)
  })
_sym_db.RegisterMessage(DocStatus)
...
GetDocumentRequest = _reflection.GeneratedProtocolMessageType('GetDocumentRequest', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.GetDocumentRequest)
  })
...
GetDocumentResponse = _reflection.GeneratedProtocolMessageType('GetDocumentResponse', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.GetDocumentResponse)
  })
_sym_db.RegisterMessage(GetDocumentResponse)

CreateByIdRequest = _reflection.GeneratedProtocolMessageType('CreateByIdRequest', (_message.Message,), {
  'DESCRIPTOR' : _CREATEBYIDREQUEST,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.CreateByIdRequest)
  })
_sym_db.RegisterMessage(CreateByIdRequest)

CreateByIdResponse = _reflection.GeneratedProtocolMessageType('CreateByIdResponse', (_message.Message,), {
  'DESCRIPTOR' : _CREATEBYIDRESPONSE,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.CreateByIdResponse)
  })
_sym_db.RegisterMessage(CreateByIdResponse)
...
CreateDocumentRequest = _reflection.GeneratedProtocolMessageType('CreateDocumentRequest', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.CreateDocumentRequest)
  })
...
CreateDocumentResponse = _reflection.GeneratedProtocolMessageType('CreateDocumentResponse', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.CreateDocumentResponse)
  })
_sym_db.RegisterMessage(CreateDocumentResponse)

CreateOrReplaceDocumentRequest = _reflection.GeneratedProtocolMessageType('CreateOrReplaceDocumentRequest', (_message.Message,), {
  'DESCRIPTOR' : _CREATEORREPLACEDOCUMENTREQUEST,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.CreateOrReplaceDocumentRequest)
  })
_sym_db.RegisterMessage(CreateOrReplaceDocumentRequest)

CreateOrReplaceDocumentResponse = _reflection.GeneratedProtocolMessageType('CreateOrReplaceDocumentResponse', (_message.Message,), {
  'DESCRIPTOR' : _CREATEORREPLACEDOCUMENTRESPONSE,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.CreateOrReplaceDocumentResponse)
  })
_sym_db.RegisterMessage(CreateOrReplaceDocumentResponse)
...
UpdateDocumentRequest = _reflection.GeneratedProtocolMessageType('UpdateDocumentRequest', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.UpdateDocumentRequest)
  })
_sym_db.RegisterMessage(UpdateDocumentRequest)

UpdateDocumentResponse = _reflection.GeneratedProtocolMessageType('UpdateDocumentResponse', (_message.Message,), {
  'DESCRIPTOR' : _UPDATEDOCUMENTRESPONSE,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.UpdateDocumentResponse)
  })
...
DeleteDocumentRequest = _reflection.GeneratedProtocolMessageType('DeleteDocumentRequest', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.DeleteDocumentRequest)
  })
...
DeleteDocumentResponse = _reflection.GeneratedProtocolMessageType('DeleteDocumentResponse', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.DeleteDocumentResponse)
  })
_sym_db.RegisterMessage(DeleteDocumentResponse)

DeleteByQueryRequest = _reflection.GeneratedProtocolMessageType('DeleteByQueryRequest', (_message.Message,), {
  'DESCRIPTOR' : _DELETEBYQUERYREQUEST,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.DeleteByQueryRequest)
  })
_sym_db.RegisterMessage(DeleteByQueryRequest)

DeleteByQueryResponse = _reflection.GeneratedProtocolMessageType('DeleteByQueryResponse', (_message.Message,), {
  'DESCRIPTOR' : _DELETEBYQUERYRESPONSE,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.DeleteByQueryResponse)
  })
_sym_db.RegisterMessage(DeleteByQueryResponse)
...
SearchIndexRequest = _reflection.GeneratedProtocolMessageType('SearchIndexRequest', (_message.Message,), {
  ...
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.SearchIndexRequest)
  })
...
SearchIndexResponse = _reflection.GeneratedProtocolMessageType('SearchIndexResponse', (_message.Message,), {
  ...
  'FacetsEntry' : _reflection.GeneratedProtocolMessageType('FacetsEntry', (_message.Message,), {
    'DESCRIPTOR' : _SEARCHINDEXRESPONSE_FACETSENTRY,
    '__module__' : 'server.v1.search_pb2'
    # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.SearchIndexResponse.FacetsEntry)
    })
  ,
  'DESCRIPTOR' : _SEARCHINDEXRESPONSE,
  '__module__' : 'server.v1.search_pb2'
  # @@protoc_insertion_point(class_scope:tigrisdata.search.v1.SearchIndexResponse)
  })
_sym_db.RegisterMessage(SearchIndexResponse)
_sym_db.RegisterMessage(SearchIndexResponse.FacetsEntry)
